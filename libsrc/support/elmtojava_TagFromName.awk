#  elmtojava_TagFromName.awk Copyright (c) 1993-2020, David A. Clunie DBA PixelMed Publishing. All rights reserved.
...
NR==1	{
	...
	print ""
	print "private static final String identString = \"@(#) $Header: /userland/cvs/dicom3tools/libsrc/support/elmtojava_TagFromName.awk,v 1.10 2020/07/24 14:58:02 dclunie Exp $\";"
	print ""
}
